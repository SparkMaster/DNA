...
public class Reference 
{
	...
	public static final String MOD_ID = "DNA";
    public static final String MOD_NAME = "Deoxyribonucleic Acid";
    public static final String VERSION = "@VERSION@";
    public static final String CHANNEL_NAME = MOD_ID;
    public static final String SERVER_PROXY_CLASS = "DNA.proxies.CommonProxyDNA";
    public static final String CLIENT_PROXY_CLASS = "DNA.proxies.ClientProxyDNA";
